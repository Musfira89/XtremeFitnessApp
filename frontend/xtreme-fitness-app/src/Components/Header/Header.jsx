  ...
  <div className="flex justify-end">
    ...
    <div className="md:hidden text-white px-4 py-6">
      ...
      >
        ...
        >
          WELCOME TO <br /> XTREMEFT
        </motion.h1>
        <p className="mt-6 text-lg md:text-xl max-w-lg leading-relaxed">
          Master the art of discipline and learn self-defense techniques to
          empower yourself and push your limits.
        </p>
        <button className="mt-10 px-14 py-4 border-2 border-white text-white uppercase font-semibold tracking-wide hover:bg-white hover:text-red-800 transition-all duration-300">
          Join Now
        </button>
      </div>
    </div>
