...
const TrainingAbout = () => {
  return (
    <div
      id="about-us"
      className="relative w-full min-h-[100vh] bg-gradient-to-r from-red-700 via-red-950 to-red-950 flex flex-col items-center justify-center px-6 py-12 md:px-12 lg:px-20 xl:px-32"
    >
      {/* Heading */}
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white text-center mb-6">
        What is Xtreme Fitness Training?
      </h2>

      {/* Description Text */}
      <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white text-center max-w-3xl leading-relaxed">
