  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <div className="mt-3 h-1 w-32 bg-red-700 mx-auto"></div>
      ...
      <div className="container mx-auto flex justify-center space-x-8">
        {/* Card 1 */}
        <motion.div
          className="w-1/4 bg-white shadow-lg rounded-lg overflow-hidden"
          initial={{ opacity: 0, x: -100 }} // Start from the left with no opacity
          whileInView={{ opacity: 1, x: 0 }} // Animate to the center with full opacity when in view
        ...
        >
          ...
          <div className="bg-red-700 text-white text-center py-8">
            <span className="text-xl font-bold">Customized Workout Routines</span>          
          </div>
        </motion.div>
        ...
        >
          ...
          />
          <div className="bg-red-700 text-white text-center py-8">
            <span className="text-xl font-bold">Personalized Meal Plans</span>          
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }} // Animate to the center with full opacity when in view
          transition={{ duration: 0.8 }}
          viewport={{ once: true }} // Trigger animation when in view
        >
          <img
          ...
          />
          <div className="bg-red-700 text-white text-center py-8">
            <span className="text-xl font-bold">Supplement Recommendation</span>          
          </div>
        </motion.div>
      </div>
    </motion.section>
