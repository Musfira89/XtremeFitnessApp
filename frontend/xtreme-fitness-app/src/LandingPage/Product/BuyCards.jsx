        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 text-center mt-12 sm:mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
            {products.map((product, index) => (
              <div
                key={index}
                className="relative bg-white shadow-lg rounded-lg overflow-hidden flex flex-col items-center transition-all transform hover:scale-105 hover:shadow-2xl w-full sm:w-[90%] md:w-[80%] lg:w-[340px] pb-4"
              >
                {/* Product Image */}
