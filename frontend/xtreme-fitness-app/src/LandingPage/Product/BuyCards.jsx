...
<div className="bg-gray-50 bg-gradient-to-r from-gray-50 to-red-50">
      ...
      >
        <div className="bg-red-700 bg-opacity-50 p-12 rounded-lg">
      ...
      <div className="max-w-4xl mx-auto mt-12 mb-6 px-6 text-center">
        <p className="text-sm text-gray-700 font-medium bg-yellow-100 p-4 rounded-md border border-yellow-300">
      ...
      {/* Heading */}
      <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center mt-20">
        <h2 className="text-4xl font-extrabold text-red-700 mb-16">
            ...
            >
              ...
              <div className="p-4 text-center w-full flex flex-col items-center">
                ...
                <a
                  ...
                  className="bg-red-600 text-white px-8 py-2 rounded-md font-semibold hover:bg-red-700 transition duration-300 inline-block"
                >
                  Buy on Amazon
                </a>
              </div>
