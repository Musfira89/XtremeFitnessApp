  ...
  return (
    <aside className="w-72 h-screen bg-gray-50 shadow-lg flex flex-col fixed top-0 left-0">
      ...
      <div className="flex flex-col items-center text-red-700 rounded-lg py-4 mb-2">
        ...
        />
        <h2 className="font-bold text-lg text-red-800">Test  User 1</h2>
        <p className="text-xs text-red-700">testuser1@example.com</p>
      </div>
      ...
      <nav className="px-6 py-2 flex-grow">
        <ul className="space-y-2">
          <li>
            ...
            >
              <FaHome className="text-red-700 text-xl" />
              <span>Home</span>
            </NavLink>
          </li>
          <li>
            ...
            >
              <FaClipboardList className="text-red-700 text-xl" />
              <span>Meal Plans</span>
            </NavLink>
          </li>
          <li>
            <NavLink
              to={`/dashboard/${userId}/workoutPlan`}
              className={({ isActive }) =>
                `flex items-center space-x-4 text-sm px-4 py-2 rounded-lg ${
                  isActive
                    ? "bg-gray-100 text-gray-800 font-semibold"
          ...
          <li>
            <NavLink
              to={`/dashboard/${userId}/supplements`}
              className={({ isActive }) =>
                `flex items-center space-x-4 text-sm px-4 py-2 rounded-lg ${
                  isActive
                    ? "bg-gray-100 text-gray-800 font-semibold"
            ...
            >
              <FaChartLine className="text-red-700 text-xl" />
              <span>Supplements</span>
            </NavLink>
          </li>
          <li>
            <NavLink
              to={`/dashboard/${userId}/progress-tracking`}
              className={({ isActive }) =>
                `flex items-center space-x-4 text-sm px-4 py-2 rounded-lg ${
                  isActive
                    ? "bg-gray-100 text-gray-800 font-semibold"
          ...
          <li>
            <NavLink
              to={`/dashboard/${userId}/meeting`}
              className={({ isActive }) =>
                `flex items-center space-x-4 text-sm px-4 py-2 rounded-lg ${
                  isActive
                    ? "bg-gray-100 text-red-700 font-semibold"
                    : "text-gray-700 hover:bg-gray-100 hover:text-gray-800"
                } transition`
              }
            >
              <FaVideo className="text-red-700 text-xl" />{" "}
              {/* Corrected class */}
          ...
          <li>
            ...
            >
              <FaBullseye className="text-red-700 text-xl" />
              <span>Profile</span>
            </NavLink>
          </li>
        </ul>
